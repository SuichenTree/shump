...
Page({
  data: {
    ...
    //获取测试结果数据渲染图表
    wx.request({
      url: getApp().globalData.current_server + "/shu/exam/result",
      method: "POST",
      header: {
    ...
    //获取用户问题数据
    wx.request({
      url: getApp().globalData.current_server + "/shu/exam/questionAnalyse",
      method: "POST",
      header: {
        'content-type': 'application/x-www-form-urlencoded',
      },
  ...
  showOption:function(e){
    ...
    wx.request({
      url: getApp().globalData.current_server + "/shu/exam/optionAnalyse",
      method: "POST",
      header: {
        'content-type': 'application/x-www-form-urlencoded',
      },
